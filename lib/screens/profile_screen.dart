...
class ProfileScreen extends ConsumerWidget {
            ...
            child: Column(
              children: [
                ...
                _Tile(
                  ...
                  title: 'Profile photo',
                  subtitle: 'Photo update karein',
                  onTap: () => _showSnack(context,
                      'Photo upload Android app mein available hoga'),
                ),
                ...
                _Tile(
                  ...
                  title: 'Family Tree',
                  subtitle: 'Poora family hierarchy',
                  onTap: () {
                  ...
                  onTap: () {
                    ...
                    if (fid != null) {
                      Navigator.push(context,
                          MaterialPageRoute(
                              builder: (_) =>
                                  CallHistoryScreen(familyId: fid)));
                    } else {
                      _showSnack(context, 'Pehle family join karein');
                    }
                  },
                ...
                if (user?.isAdmin == true) ...[
                  ...
                  _Tile(
                    ...
                    subtitle: 'Members manage karein',
  ...
  // ── REAL naam update — Firestore mein save hota hai ──────────
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              // ACTUALLY Firestore mein save karo
              ...
              Navigator.pop(ctx);
              _showSnack(context, '✅ Naam "${newName}" save ho gaya!');
            },
