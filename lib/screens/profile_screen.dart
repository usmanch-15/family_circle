                  ...
                  data:    (groups) => Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        _Divider(),
                        _StatItem(value: user?.isAdmin == true ? 'Admin' : 'Member', label: 'Role'),
                        _Divider(),
                        _StatItem(value: Helpers.formatDate(user?.createdAt ?? DateTime.now()), label: 'Joined'),
                      ],
                    ),
                  ),
                ),
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              // TODO: update name in Firestore
              Navigator.pop(ctx);
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Naam update ho gaya'), behavior: SnackBarBehavior.floating),
              );
            },
